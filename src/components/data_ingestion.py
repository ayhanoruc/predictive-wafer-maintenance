...
class DataIngestionComponent:
    ...
    def export_raw_data_into_feature_store(self):
        ...
        connection.ingest_with_fs(
            target_dir=self.data_ingestion_config.feature_store_dir,
            collection_name=self.data_ingestion_config.training_collection_name,
        )
    ...
    def run_data_ingestion(self) -> DataIngestionArtifact:
        ...
        self.log_writer.handle_logging(
            "-------------ENTERED RAW DATA INGESTION STAGE------------"
        )
