...
class ModelPusherComponent:
    ...
    def run_model_pusher(self) -> ModelPusherArtifact:
        ...
        self.log_writer.handle_logging(
            "last trained model is copied & moved to model pusher artifact as .pkl object"
        )
        ...
        self.log_writer.handle_logging(
            "last trained model is copied & moved to saved models as .pkl object"
        )

        model_pusher_artifact = ModelPusherArtifact(
            saved_model_path=saved_model_path, model_file_path=model_dst_file_path
        )
