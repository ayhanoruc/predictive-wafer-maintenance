...
class TrainingPipelineConfig:
    def __init__(self, timestamp=datetime.now()):
        ...
        self.artifact_dir = os.path.join(
            PROJECT_ROOT, training_pipeline.ARTIFACT_DIR_NAME, self.timestamp
        )
...
class DataIngestionConfig:  # raw data ingestion
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        ...
        )  # These are used after split operation
        ...
        self.unseen_collection_name = (
            training_pipeline.UNSEEN_COLLECTION_NAME
        )  # we will ingest this after the best model obtained, this will play as real-time unseen data,(monitoring purpose)
...
class DataValidationConfig:
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        ...
        self.data_validation_training_dir = os.path.join(
            self.data_validation_dir, training_pipeline.DATA_VALIDATION_TRAINING_DIR
        )
        self.data_validation_unseen_dir = os.path.join(
            self.data_validation_dir, training_pipeline.DATA_VALIDATION_UNSEEN_DIR
        )

        self.valid_training_data_dir = os.path.join(
            self.data_validation_training_dir,
            training_pipeline.DATA_VALIDATION_VALID_DIR,
        )
        self.invalid_training_data_dir = os.path.join(
            self.data_validation_training_dir,
            training_pipeline.DATA_VALIDATION_INVALID_DIR,
        )

        self.valid_unseen_data_dir = os.path.join(
            self.data_validation_unseen_dir, training_pipeline.DATA_VALIDATION_VALID_DIR
        )
        self.invalid_unseen_data_dir = os.path.join(
            self.data_validation_unseen_dir,
            training_pipeline.DATA_VALIDATION_INVALID_DIR,
        )

        self.mongo_valid_collection_name = training_pipeline.MONGO_VALID_COLLECTION_NAME
        self.mongo_invalid_collection_name = (
            training_pipeline.MONGO_INVALID_COLLECTION_NAME
        )

        self.prediction_data_dir = os.path.join(
            PROJECT_ROOT, training_pipeline.PREDICTION_DATASET_DIR
        )
...
class ModelTrainerConfig:
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        ...
        self.model_trainer_trained_model_file_path = os.path.join(
            self.model_trainer_dir,
            training_pipeline.MODEL_TRAINER_TRAINED_MODEL_DIR,
            training_pipeline.MODEL_TRAINER_TRAINED_MODEL_NAME,
        )

        self.expected_roc_auc_score = (
            training_pipeline.MODEL_TRAINER_EXPECTED_ROC_AUC_SCORE
        )
...
class ModelPusherConfig:
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        self.model_pusher_dir = os.path.join(
            training_pipeline_config.artifact_dir, training_pipeline.MODEL_PUSHER_DIR
