...
class PredictionPipeline:
    ...
    def start_model_prediction(self, data_validation_artifact:DataValidationArtifact):
        ...
        self.log_writer.handle_logging(f"Loaded dataframe for prediction with shape: {dataframe.shape}")
        ...
        self.log_writer.handle_logging(f"Obtained and returned best_model_y_pred & best_model_metrics")
    ...
    def start_prediction_pipeline(self):
        ...
        self.log_writer.handle_logging("-------------ENTERED PREDICTION PIPELINE STAGE------------")
